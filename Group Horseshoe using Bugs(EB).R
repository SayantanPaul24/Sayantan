...
inits<- function(){
  list(beta1=c(0.0251,0.0252),beta2=c(0.0254,0.0253),beta3=c(0.01,0.24),beta4=c(2.23,2.11),beta5=c(0.05,0.04),k=c(0.3792589886,0.9000829897,0.3894594,0.5986663, 0.9641334))
}

ifelse(t(beta2)%*%t(X2)%*%X2%*%beta2>log(5),1,0)
ifelse(t(beta4)%*%t(X4)%*%X4%*%beta4>log(5),1,0)

Modi1.sim <- bugs(data, inits, model.file = "C:/Users/Sayantan/Documents/Modified Group Horseshoe(EB) n=20,p=10.bug",
...
Modi2.sim <- bugs(data, inits, model.file = "C:/Users/Sayantan/Documents/Usual group Horseshoe(EB) n=20,p=10.bug",
                  parameters = c("beta1", "beta2", "beta3","beta4","beta5"),
                  n.chains = 1, n.iter = 10000,n.sims = 3000, bugs.directory = "C:/Users/Sayantan/Downloads/winbugs143_unrestricted/winbugs14_full_patched/WinBUGS14/",DIC = FALSE)

Modi3.sim <- bugs(data, inits, model.file = "C:/Users/Sayantan/Documents/Modified Group Horseshoe(EB2) n=20,p=10.bug",
                  parameters = c("beta1", "beta2", "beta3","beta4","beta5"),
                  n.chains = 1, n.iter = 10000,n.sims = 3000,  bugs.directory = "C:/Users/Sayantan/Downloads/winbugs143_unrestricted/winbugs14_full_patched/WinBUGS14/",DIC = FALSE)
