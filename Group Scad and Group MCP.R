...
v.group <-c(rep(1,2),rep(2,2),rep(3,2),rep(4,2),rep(5,2),rep(6,2),rep(7,2),rep(8,2),rep(9,2),rep(10,2))
...
#X
#dim(X)
beta<-c(0.1,0.2,0.3,0.4,rep(0,36))
...
v.group <-c(rep(1,4),rep(2,3),rep(3,3),rep(4,2),rep(5,2),rep(6,2),rep(7,2),rep(8,2),rep(9,2),rep(10,4),
            rep(11,4),rep(12,4),rep(13,4),rep(14,2),rep(15,5),rep(16,5))
...
#X
#dim(X)
beta<-c(0.1,0.2,0.3,0.4,rep(0,96))
...
#X
dim(X)
beta<-c(1,2,3,4,0.1,0.2,0.3,0.4,rep(0,42))
...
#X
#dim(X)
beta<-c(1.1,1.2,1.3,1.4,rep(0,36))
...
#X
#dim(X)
beta<-c(1.1,1.2,1.3,1.4,rep(0,96))
...
#X
#dim(X)
beta<-c(rep(1,4),rep(1.2,4),rep(1.4,4),rep(0,88))
...
#X
#dim(X)
beta<-c(rep(0.4,4),rep(0.5,4),rep(0.6,4),rep(0,88))
...
#X
#dim(X)
beta<-c(rep(1.8,4),rep(0.6,4),rep(0.5,4),rep(2.5,4),rep(0,84))
...
#X
#dim(X)
beta<-c(rep(1.8,4),rep(1.5,4),rep(1.8,4),rep(1.5,4),rep(0.6,4), rep(2.5,4), rep(2.5,4), rep(0.4,4), rep(0,68))
...
beta<-c(rep(0,4),rep(0,2),rep(0.2,2),rep(0,2))
...
v.group <-c(rep(1,2),rep(2,2),rep(3,2),rep(4,2),rep(5,2))

gr_cv2 <- cv.grpreg(Z, y, group= v.group, penalty = "grSCAD",
                    loss="ls", pred.loss="L2", 
                    intercept = F, nfolds=5)


grscad = grpreg(Z, y, lambda = gr_cv2$lambda.min,group = v.group, penalty = "grSCAD", loss="ls", intercept = F)
#grscad
print(grscad$beta[,1])

gr_cv3 <- cv.grpreg(Z, y, group=v.group, penalty = "grMCP",
                    loss="ls", pred.loss="L2", 
                    intercept = F, nfolds=5)
grMCP = grpreg(Z, y, lambda = gr_cv3$lambda.min,group = v.group, penalty = "grMCP", loss="ls", intercept = F)
#grscad
print(grMCP$beta[,1])
